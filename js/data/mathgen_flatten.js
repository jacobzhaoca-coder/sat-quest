...
(function flattenMathDispatch() {
  const MC = {
    ...
    'linear-func': [gen_linear_func, gen2_linear_rate, gen3_slope, gen7_line_from_table, gen7_interpret_slope, gen7_interpret_intercept, gen7_match_equation, gen7_parallel_perp_slope, gen9_slope_from_standard, gen10_two_point_line],
    'systems': [gen_systems, gen2_systems_word, gen5_system_word, gen7_no_solution, gen7_infinite_solutions, gen9_break_even, gen9_system_target, gen10_solution_check],
    ...
    'equivalent': [gen_equivalent, gen3_distribute, gen3_exponents, gen7_rational_undefined, gen7_rational_simplify, gen9_literal_solve, gen10_combine_like, gen10_factor_gcf, gen10_exp_rules],
    'quadratics': [gen_quadratics, gen2_vertex, gen3_quadratic_roots, gen4_quad_axis, gen4_quad_sumprod, gen6_quadratic_vertex, gen6_quadratic_other_root, gen7_complete_square, gen7_discriminant, gen7_nonlinear_count, gen9_sum_product_roots, gen9_vertex_from_factored, gen10_diff_squares, gen10_build_quadratic, gen10_min_value],
    ...
    'functions': [gen_functions, gen2_composition, gen3_poly_eval, gen5_function_composition, gen7_func_transform, gen7_func_from_table, gen9_avg_rate, gen10_func_composition_val],
    'ratios': [gen_ratios, gen2_proportion, gen3_ratio_partition, gen3_speed, gen5_ratio_share, gen8_unit_conversion, gen8_density, gen9_unit_rate_deal, gen9_combined_rate, gen10_recipe_scale, gen10_ratio_to_total],
    'percentages': [gen_percentages, gen2_percent_change, gen3_percent_of, gen5_percent_change, gen8_percent_compare, gen9_successive_percent, gen9_percent_of_percent, gen10_percent_error],
    'statistics': [gen_statistics, gen2_mean_target, gen3_median, gen5_weighted_avg, gen8_stat_measure, gen8_spread_compare, gen8_median_frequency, gen9_range, gen10_mean_after_add],
    'scatterplots': [gen_scatterplots, gen4_scatter_predict, gen4_scatter_slope, gen6_best_fit, gen8_residual, gen8_association],
    'probability': [gen_probability, gen3_probability, gen4_two_way, gen6_two_way_prob, gen8_prob_complement, gen8_prob_joint_table, gen9_expected_value, gen9_at_least_one, gen10_conditional_prob],
    'sampling': [gen_sampling, gen4_sampling_valid, gen4_sampling_margin],
    'area-volume': [gen_area_volume, gen2_pythagorean, gen3_area_triangle, gen3_volume_box, gen8_solid_volume, gen9_composite_area, gen9_surface_area_box, gen9_scale_volume, gen10_trapezoid_area],
    'angles': [gen_angles, gen2_triangle_angle, gen2_supplement, gen3_similar, gen8_distance, gen8_midpoint, gen8_transversal, gen8_polygon_sum, gen8_pyth_leg, gen8_similar_algebra, gen9_triangle_inequality, gen10_similar_perimeter],
    'circles': [gen_circles, gen2_circle, gen4_circle_sector, gen4_circle_equation, gen6_circle_radius, gen8_circle_write_eq, gen8_arc_length, gen9_circle_area_from_circ, gen9_inscribed_angle, gen10_sector_area, gen10_circle_general_form],
    'trig': [gen_trig, gen2_trig_ratio, gen3_special_right, gen4_trig_complement, gen4_trig_side, gen6_special_triangle, gen6_trig_ratio, gen10_special_306090, gen10_trig_find_angle],
  };
  const GRID = {
    ...
    'inequalities': [grid_inequalities, gen7grid_compound, gen10grid_inequality],
    ...
    'functions': [grid_functions, gen7grid_func_from_table, gen9grid_avg_rate, gen10grid_composition],
    'percentages': [grid_percentages, gen2grid_percent_change, gen3grid_percent_of, gen8grid_percent_compare, gen10grid_percent_error],
    'ratios': [grid_ratios, gen2grid_proportion, gen3grid_ratio_partition, gen8grid_density],
    'statistics': [grid_statistics, gen2grid_mean_target, gen3grid_median, gen9grid_range, gen10grid_mean_after_add],
    'probability': [grid_probability, gen8grid_prob_complement, gen10grid_ratio_total],
    'angles': [grid_angles, gen2grid_triangle_angle, gen6grid_pythagorean, gen8grid_distance, gen8grid_polygon_sum],
    'area-volume': [grid_area, gen2grid_pythagorean, gen3grid_area_triangle, gen9grid_composite_area, gen9grid_surface_area, gen10grid_trapezoid],
    'trig': [grid_trig, gen4grid_trig_side],
    'circles': [gen4grid_circle_sector, gen6grid_circle_radius, gen10grid_sector_area],
